...
export const GOOGLE_API_KEY = 'AIzaSyCo_4zK_GAIROKvLU4YDqnjaS_NYWKJjV4';
...
export const YOUTUBE_API = 'http://suggestqueries.google.com/complete/search?client=youtube&ds=yt&client=firefox&q=';
